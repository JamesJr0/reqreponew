...
links_btn = [
    [
        InlineKeyboardButton("ʙᴏᴛ ᴜᴘᴅᴀᴛᴇꜱ", url = f"{UPDATES_CHANNEL}"),
        InlineKeyboardButton("ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ", url = f"{MOVIE_GROUP}")
    ],
    [
        InlineKeyboardButton( "ꜱᴇᴀʀᴄʜ ʙᴏᴛ", url = f"{MOVIE_BOT}"),
        InlineKeyboardButton("ʟᴀᴛᴇꜱᴛ ᴜᴘʟᴏᴀᴅꜱ", url = f"{LATEST_UPLOADS}")
    ],
    [
